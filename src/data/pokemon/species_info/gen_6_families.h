...
const struct SpeciesInfo gSpeciesInfoGen6[] =
{
    ...
    [SPECIES_FENNEKIN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MAGIC_BOUNCE, ABILITY_BLAZE, ABILITY_MAGICIAN },
    ...
    [SPECIES_FROAKIE] =
    {
        ...
        .abilities = { ABILITY_PROTEAN, ABILITY_TORRENT, ABILITY_PROTEAN },
...
#define VIVILLON_MISC_INFO(form, color, iconPal)                                            \
    ...
    [SPECIES_LITLEO] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_MOXIE, ABILITY_UNNERVE, ABILITY_MOXIE },
        .bodyColor = BODY_COLOR_BROWN,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 150 : 150)
    ...
    [SPECIES_INKAY] =
    {
        ...
        .abilities = { ABILITY_CONTRARY, ABILITY_TORRENT, ABILITY_INFILTRATOR },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Inkay"),
        .cryId = CRY_INKAY,
    ...
    #endif
        .abilities = { ABILITY_MOLD_BREAKER, ABILITY_UNBURDEN, ABILITY_MOLD_BREAKER },
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_GOOMY] =
    {
        ...
        .abilities = { ABILITY_GOOEY, ABILITY_UNAWARE, ABILITY_GOOEY },
    ...
    [SPECIES_SLIGGOO_HISUIAN] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_GOOEY, ABILITY_SHELL_ARMOR, ABILITY_GOOEY },
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Sliggoo"),
        .cryId = CRY_SLIGGOO,
        .natDexNum = NATIONAL_DEX_SLIGGOO,
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .abilities = { ABILITY_RIPEN, ABILITY_BATTLE_ARMOR, ABILITY_INSOMNIA },
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ZYGARDE_50_AURA_BREAK] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_NO_EGGS_DISCOVERED),
        .abilities = { ABILITY_DRAGONS_MAW, ABILITY_TERRA_FIRMA, ABILITY_NONE },
        .bodyColor = BODY_COLOR_GREEN,
        .noFlip = TRUE,
