...
#define AMPHAROS_DEFENSE (P_UPDATED_STATS >= GEN_6 ? 95 : 95)
    ...
    [SPECIES_AIPOM] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 35, SPECIES_AMBIPOM}),
    },
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_GIRAFARIG] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 44, SPECIES_FARIGIRAF}),
    },
    ...
    [SPECIES_SNEASEL_HISUIAN] =
    {
        ...
        .formSpeciesIdTable = sSneaselFormSpeciesIdTable,
        .evolutions = EVOLUTION({EVO_LEVEL, 45, SPECIES_SNEASLER}),
    },
