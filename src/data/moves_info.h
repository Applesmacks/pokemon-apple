...
const struct MoveInfo gMovesInfo[MOVES_COUNT_DYNAMAX] =
{
    ...
    [MOVE_MIST] =
    {
        ...
        .description = COMPOUND_STRING(
            "Creates a chilling mist that\n"
            "causes frostbite on the foe."),
        .effect = EFFECT_MIST,
        .power = 0,
        .type = TYPE_ICE,
        .accuracy = 85,
    ...
    [MOVE_BOUNCE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Bounces up, then onto the\n"
            "opponent. May paralyze."),
        .effect = EFFECT_HIT,
        .power = 85,
        .type = TYPE_FLYING,
        .accuracy = 90,
    ...
    [MOVE_TERA_BLAST] =
    {
        ...
        .effect = EFFECT_HIT, // EFFECT_TERA_BLAST,
        .power = 80,
        .type = TYPE_NORMAL,
        .accuracy = 100,
        .pp = 10,
