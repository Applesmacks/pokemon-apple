...
{//                   Defender -->
 //  Attacker         Normal  Fighting Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy
    ...
    [TYPE_POISON]   = {______, X(2.0), ______, X(0.5), X(0.5), X(0.5), X(0.5), X(0.5), X(0.0), ______, ______, X(2.0), X(2.0), ______, ______, ______, ______, ______, X(2.0)},
    ...
    [TYPE_PSYCHIC]  = {______, X(2.0), ______, X(2.0), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, ______, X(0.0), ______},
    ...
    case ABILITYEFFECT_MOVE_END_ATTACKER: // Same as above, but for attacker
        ...
        case ABILITY_POISON_PUPPETEER:
            if ((gBattleMons[gBattlerAttacker].species == SPECIES_PECHARUNT
             || gBattleMons[gBattlerAttacker].species == SPECIES_SHUPPET
             || gBattleMons[gBattlerAttacker].species == SPECIES_BANETTE
             || gBattleMons[gBattlerAttacker].species == SPECIES_BANETTE_MEGA)
