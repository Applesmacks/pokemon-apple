...
#define B_FLAG_INVERSE_BATTLE       FLAG_UNUSED_0x266     // If this flag is set, the battle's type effectiveness are inversed. For example, fire is super effective against water.
...
#define B_VAR_STARTING_STATUS       FLAG_UNUSED_0x267     // If this var has a value, assigning a STATUS_FIELD_xx_TERRAIN to it before battle causes the battle to start with that terrain active.
